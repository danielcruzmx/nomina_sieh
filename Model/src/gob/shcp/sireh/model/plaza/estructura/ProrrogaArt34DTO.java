...
public class ProrrogaArt34DTO extends TdPlazaDTO implements java.io.Serializable, Model {
    ...
    private java.lang.String tipoProrroga;
    ...
    @ValidationMethod(forProperty = "tipoProrroga", errorCode = "not.blank")
    public boolean validateTipoProrroga() {
        return this.getTipoProrroga() != null && !this.getTipoProrroga().equals("");
    }
}
