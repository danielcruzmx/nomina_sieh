...
public class ObservacionesPlazaDTO extends TdPlazaDTO implements java.io.Serializable, Model {
    ...
    public boolean validatePlazaReferencia() {
        return this.getPlazaReferencia() != null && !this.getPlazaReferencia().equals("");
    }
}