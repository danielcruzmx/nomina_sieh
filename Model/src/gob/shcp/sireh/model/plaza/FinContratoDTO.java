...
public class FinContratoDTO implements java.io.Serializable, Model {
    ...
    public FinContratoDTO() {   }
    
    public FinContratoDTO(String quincena, String plazaIniContrato, String plazaFinContrato, String curpEmpleado, String rfcEmpleado, String pApellido, String sApellido, String nombre,
                        String puesto, String plaza, String nivelPuesto, String unidad, String DESC_GRUPO_PAGO) {   
