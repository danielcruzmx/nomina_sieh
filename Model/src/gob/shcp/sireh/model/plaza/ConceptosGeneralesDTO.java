...
public class ConceptosGeneralesDTO implements java.io.Serializable, Model  { 
    //QUERY 1
    // TD_EMPLEADO
    ...
    public ConceptosGeneralesDTO(){ }
    
    public ConceptosGeneralesDTO(       java.lang.String rfcEmpleado,
