...
public class NivelesRespRuspDTO implements java.io.Serializable, Model {
    ...
    public void setNivelesResp(String nivelesResp) {
        this.nivelesResp = nivelesResp;
    }

    public String getNivelesResp() {
        return nivelesResp;
    }
    ...
    // Validaciones
    @ValidationMethod(forProperty = "nivelesResp", errorCode = "not.null")
    public boolean validateNivelesResp() {
        return this.getNivelesResp() != null && !this.getNivelesResp().equals("");
    }
}
