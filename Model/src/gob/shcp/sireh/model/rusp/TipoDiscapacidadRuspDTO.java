...
public class TipoDiscapacidadRuspDTO implements java.io.Serializable, Model {
    ...
    // Validaciones
    @ValidationMethod(forProperty = "idDiscapacidad", errorCode = "not.null")
    public boolean validateIdDiscapacidad() {
        return this.getIdDiscapacidad() != null && this.getIdDiscapacidad() > 0;
    }
}
