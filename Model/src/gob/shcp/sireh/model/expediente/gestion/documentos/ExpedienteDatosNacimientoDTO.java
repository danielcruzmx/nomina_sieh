...
public class ExpedienteDatosNacimientoDTO extends FsnResource implements Model {
    ...
    public ExpedienteDatosNacimientoDTO() {
        super(NODE_TYPE);
        setVersionable(true);
    }

    public ExpedienteDatosNacimientoDTO(Map properties) {
    ...
    public void setFormaFM3(String formaFM3) {
        this.formaFM3 = formaFM3;
    }

    public String getFormaFM3() {
        return formaFM3;
    }
    ...
    public boolean validateNombreEmpleadoRequired() {
        if (this.isRegistrar()) {
            return (this.getNombreEmpleado() != null && 
                    !this.getNombreEmpleado().equals(""));
        }
        return true;
    }
    ...
    @ValidationMethod(forProperty = "nacionalidad", errorCode = "not.null")
    public boolean validateNacionalidadRequired() {
        if (this.isRegistrar()) {
            return (this.getNacionalidad() != null && 
                    !this.getNacionalidad().equals(""));
        }
        return true;
    }

    @ValidationMethod(forProperty = "entidadFederativa", 
                      errorCode = "not.null")
    public boolean validateEntidadFederativaRequired() {
        if (this.isRegistrar()) {
            return (this.getEntidadFederativa() != null && 
                    !this.getEntidadFederativa().equals(""));
        }
        return true;
    }

    @ValidationMethod(forProperty = "fecNacimiento", errorCode = "not.null")
    public boolean validateFecNacimientoRequired() {
        if (this.isRegistrar()) {
            return (this.getFecNacimiento() != null && 
                    !this.getFecNacimiento().equals(""));
        }
        return true;
    }
