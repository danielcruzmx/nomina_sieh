...
public class ExpedienteAvisoAccidenteDTO extends FsnResource implements Model {
    ...
    // JCR
    public ExpedienteAvisoAccidenteDTO() {
        super(NODE_TYPE);
        setVersionable(true);
    }
    public ExpedienteAvisoAccidenteDTO(Map properties) {
    ...
    // Validaciones
    @ValidationMethod(forProperty = "nombre", errorCode = "not.null")
    public boolean validateNombreRequired() {
        if (this.isRegistrar()) {
            return (this.getNombre() != null && !this.getNombre().equals(""));
        }
        return true;
    }

    @ValidationMethod(forProperty = "telefono1", errorCode = "not.null")
    public boolean validateTelefono1Requiered() {
        if (this.isRegistrar()) {
            return (this.getTelefono1() != null && !this.getTelefono1().equals(""));
        }
        return true;
    }
    
    @ValidationMethod(forProperty = "telefono2", errorCode = "not.null")
    public boolean validateTelefono2Requiered() {
        if (this.isRegistrar()) {
            return (this.getTelefono2() != null && !this.getTelefono2().equals(""));
        }
        return true;
    }
    ...
    public boolean validateParentescoRequiered() {
        if (this.isRegistrar()) {
            return (this.getParentesco()!= null);
        }
        return true;
    }
}
