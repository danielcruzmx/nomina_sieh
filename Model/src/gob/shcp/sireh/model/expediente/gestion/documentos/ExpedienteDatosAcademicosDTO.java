...
public class ExpedienteDatosAcademicosDTO extends FsnResource implements Model {
    ...
    private BigDecimal promedioEscolar;
    ...
    // JCR
    public ExpedienteDatosAcademicosDTO() {
        super(NODE_TYPE);
        setVersionable(true);
    }
    public ExpedienteDatosAcademicosDTO(Map properties) {
    ...
    public void setPromedioEscolar(BigDecimal promedioEscolar) {
        this.promedioEscolar = promedioEscolar;
    }

    public BigDecimal getPromedioEscolar() {
    ...
    @ValidationMethod(forProperty = "nivelEscolar", errorCode = "not.null")
    public boolean validateNivelEscolarRequired() {
        if (this.isRegistrar()) {
            return (this.getNivelEscolar() != null && this.getNivelEscolar().toString().length() > 0);
        }
        return true;
    }
    
    
    @ValidationMethod(forProperty = "carrera", errorCode = "not.null")
    public boolean validateCarreraRequired() {
        if (this.isRegistrar()) {
            return (this.getCarrera() != null && this.getCarrera().toString().length() > 0);
        }
        return true;
    }
    ...
    public boolean validateInstEducatRequired() {
        if (this.isRegistrar()) {
            return (this.getInstEducat() != null && this.getInstEducat().toString().length() > 0);
        }
        return true;
    }
    ...
    public boolean validateEstudiosConcluidosRequired() {
        if (this.isRegistrar()) {
            return (this.getEstudiosConcluidos() != null && this.getEstudiosConcluidos().length() > 0);
        }
        return true;
    }
    
    /*@ValidationMethod(forProperty = "promedioEscolar", errorCode = "not.null")
    public boolean validatePromedioEscolarRequired() {
        if (this.isRegistrar()) {
            return (this.getPromedioEscolar() != null && this.getPromedioEscolar().toString().length() > 0);
        }
        return true;
    }
    
    
    @ValidationMethod(forProperty = "cedulaProfesional", errorCode = "not.null")
    public boolean validateCedulaProfesionalRequired() {
        if (this.isRegistrar()) {
            return (this.getCedulaProfesional() != null && this.getCedulaProfesional().length() > 0);
        }
        return true;
    }*/
