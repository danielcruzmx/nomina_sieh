...
public class ExpedienteCuentasBancariasDTO extends FsnResource implements Model {
    ...
    // JCR
    public ExpedienteCuentasBancariasDTO() {
        super(NODE_TYPE);
        setVersionable(true);
    }
    public ExpedienteCuentasBancariasDTO(Map properties) {
    ...
    // Validaciones
    @ValidationMethod(forProperty = "banco", errorCode = "not.null")
    public boolean validateBancoRequired() {
        if (this.isRegistrar()) {
            return (this.getBanco() != null && !this.getBanco().equals(""));
        }
        return true;
    }
    

   /* @ValidationMethod(forProperty = "clabe", errorCode = "not.null")
    public boolean validateClabeRequired() {
        if (this.isRegistrar()) {
            return (this.getClabe() != null && !this.getClabe().equals(""));
        }
        return true;
    }*/
