...
public class ClcPatronalesDTO implements java.io.Serializable, Model {
    ...
    private String nominasCadena;
    private String[] nominaGrupo;
    ...
    public String getNominasCadena() {
        return nominasCadena;
    }

    public void setNominasCadena(String nominasCadena) {
        this.nominasCadena = nominasCadena;
    }

    public String[] getNominaGrupo() {
        return nominaGrupo;
    }

    public void setNominaGrupo(String[] nominaGrupo) {
        this.nominaGrupo = nominaGrupo;
    }
