...
public class ProcesoNmDTO implements Serializable, Model{
   ...
   private List <ProcesoNmDTO> listaErrores;
   ...
   private List<ProcesoNmDTO> resumenList = new ArrayList<ProcesoNmDTO>();
   private List<ProcesoNmDTO> resumenAnosConsecutivosList = new ArrayList<ProcesoNmDTO>();
   private Boolean validaNotaMeritoManual = false;
    ...
    private java.util.List<EncabezadoConsecutividad> encabezadoConsecutividadList = new ArrayList<EncabezadoConsecutividad>();
    private java.util.List<CausalConsecutividad> causalConsecutividadList = new ArrayList<CausalConsecutividad>();
    private java.lang.Integer regreso;
   ...
   public ProcesoNmDTO() {
       ...
       ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero> listaCiclos = new ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero>();
       listaCiclos.add(this.getInstanceEtiquetaClaveValorEntero(anioActual,anioActual.toString()));
       anioActual--;
       listaCiclos.add(this.getInstanceEtiquetaClaveValorEntero(anioActual,anioActual.toString()));
       this.setCicloValores(listaCiclos);
       ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero> listaCausal = new ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero>();
    ...
    public ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero> getCicloValores() {
        return cicloValores;
    }

    public void setCicloValores(ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero> cicloValores) {
    ...
    public PuntoCausalConsecutividad getInstanceOfPuntoCausalConsecutividad(Integer tdNmhCiclo, Integer punto, boolean muestraValor ) {
        PuntoCausalConsecutividad puntoCausalConsecutividad = new PuntoCausalConsecutividad(tdNmhCiclo, punto, muestraValor);
        return puntoCausalConsecutividad;
    }
    
    public CausalConsecutividad getInstanceOfCausalConsecutividad(Integer tdNmhCveCausal, String nombreCausal, String color) {
    ...
    public List<ProcesoNmDTO> getListaErrores() {
        return listaErrores;
    }

    public void setListaErrores(List<ProcesoNmDTO> listaErrores) {
    ...
    public ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero> getCausalValores() {
        return causalValores;
    }

    public void setCausalValores(ArrayList<ProcesoNmDTO.EtiquetaClaveValorEntero> causalValores) {
    ...
    public List<ProcesoNmDTO> getResumenList() {
        return resumenList;
    }

    public void setResumenList(List<ProcesoNmDTO> resumenList) {
        this.resumenList = resumenList;
    }

    public List<ProcesoNmDTO> getResumenAnosConsecutivosList() {
        return resumenAnosConsecutivosList;
    }

    public void setResumenAnosConsecutivosList(List<ProcesoNmDTO> resumenAnosConsecutivosList) {
    ...
    public List<ProcesoNmDTO.EncabezadoConsecutividad> getEncabezadoConsecutividadList() {
        return encabezadoConsecutividadList;
    }

    public void setEncabezadoConsecutividadList(List<ProcesoNmDTO.EncabezadoConsecutividad> encabezadoConsecutividadList) {
        this.encabezadoConsecutividadList = encabezadoConsecutividadList;
    }

    public List<ProcesoNmDTO.CausalConsecutividad> getCausalConsecutividadList() {
        return causalConsecutividadList;
    }

    public void setCausalConsecutividadList(List<ProcesoNmDTO.CausalConsecutividad> causalConsecutividadList) {
    ...
    public void setTamanioEncabezadoConsecutividadList(Integer tamanioEncabezadoConsecutividadList) {
        this.tamanioEncabezadoConsecutividadList = 
                tamanioEncabezadoConsecutividadList;
    }

    public Integer getRegreso() {
        return regreso;
    }

    public void setRegreso(Integer regreso) {
    ...
    private Integer tdNmhCiclo;
        ...
        public EncabezadoConsecutividad(Integer consecutivo, Integer tdNmhCiclo ) {this.setConsecutivo(consecutivo);
    ...
    private List<PuntoCausalConsecutividad> puntoCausalConsecutividadList = new ArrayList<PuntoCausalConsecutividad>();
    ...
    public CausalConsecutividad(Integer tdNmhCveCausal, String nombreCausal, String color){
        ...
        public List<ProcesoNmDTO.PuntoCausalConsecutividad> getPuntoCausalConsecutividadList() {
            return puntoCausalConsecutividadList;
        }

        public void setPuntoCausalConsecutividadList(List<ProcesoNmDTO.PuntoCausalConsecutividad> puntoCausalConsecutividadList) {
