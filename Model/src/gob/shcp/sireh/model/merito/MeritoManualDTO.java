...
public class MeritoManualDTO implements Serializable, Model{
   ...
   private List <MeritoManualDTO> listaErrores;
   ...
   private List<MeritoManualDTO> resumenList = new ArrayList<MeritoManualDTO>();
   private List<MeritoManualDTO> resumenAnosConsecutivosList = new ArrayList<MeritoManualDTO>();
   ...
   public MeritoManualDTO() {
       Date hoy = new Date();
       Calendar cal = Calendar.getInstance();
       cal.setTime(hoy);
       Integer anioActual = cal.get(Calendar.YEAR);
       ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero> listaCiclos = new ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero>();
       listaCiclos.add(this.getInstanceEtiquetaClaveValorEntero(anioActual,anioActual.toString()));
       anioActual--;
       listaCiclos.add(this.getInstanceEtiquetaClaveValorEntero(anioActual,anioActual.toString()));
       this.setCicloValores(listaCiclos);
       ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero> listaCausal = new ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero>();
    ...
    public ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero> getCicloValores() {
        return cicloValores;
    }

    public void setCicloValores(ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero> cicloValores) {
    ...
    public List<MeritoManualDTO> getListaErrores() {
        return listaErrores;
    }

    public void setListaErrores(List<MeritoManualDTO> listaErrores) {
    ...
    public ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero> getCausalValores() {
        return causalValores;
    }

    public void setCausalValores(ArrayList<MeritoManualDTO.EtiquetaClaveValorEntero> causalValores) {
    ...
    public List<MeritoManualDTO> getResumenList() {
        return resumenList;
    }

    public void setResumenList(List<MeritoManualDTO> resumenList) {
        this.resumenList = resumenList;
    }

    public List<MeritoManualDTO> getResumenAnosConsecutivosList() {
        return resumenAnosConsecutivosList;
    }

    public void setResumenAnosConsecutivosList(List<MeritoManualDTO> resumenAnosConsecutivosList) {
