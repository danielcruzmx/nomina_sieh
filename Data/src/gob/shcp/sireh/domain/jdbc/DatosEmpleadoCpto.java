...
public class DatosEmpleadoCpto implements Domain, Serializable {
    ...
    public DatosEmpleadoCpto() {
    }

    public DatosEmpleadoCpto(String rfcEmpleado, String nombreEmpleado, 
                             String primerApellido, String segundoApellido, 
                             Integer idPlaza, String idUnidadNom, 
                             String idPuestoNom, String descUnidad, 
                             String descPuesto, BigDecimal tabSueldo, 
                             BigDecimal tabCompensacion, String idNivelPto, 
                             String descNomNombramiento, String idNombramiento, 
                             BigDecimal mcpMonto, BigDecimal mcpPorcentaje, 
                             BigDecimal mcpMontoAdeudo, String usuario, 
                             String idSitCaptura, String idTipoCpto, 
                             String idConcepto, String descConPag, 
                             String cpcTipoCaptura, String cpcTipoCalculo, 
                             String cpcPermanente, String cpcMensaje, 
                             String cpcSubTipo, String cpcSubTipoDesc, 
                             String fistCharOnIdNivelPto, 
                             String fistCharOnIdNombramiento, 
                             String selectedConceptoComboBox, 
                             String mcpRefCancela, Integer mcpQnaCancelo, 
                             Map<String, Object> mapaOpcionesRdButtons, 
                             Map<String, Object> listaOrdenadaQuincenas, 
                             Integer mcpQnaIni, Integer mcpQnaFin, 
                             Integer mcpQnaADescontar, String mcpQnaIniLabel, 
                             String mcpPorcentajeLabel, Integer anioQnaInicial, 
                             Integer qnaQnaInicial, String qnaIniLabel, 
                             String mcpRefCaptura, String opcionRdButton, 
                             Integer opcionRdButtonInt, String mcpMontoLabel, 
                             java.util.Date mcpFecIniAdeudo, 
                             java.util.Date mcpFecFinAdeudo, 
                             String descSitCaptura, Date mcpFecIncidencia, 
                             BigDecimal mcpHorasDias, BigDecimal mcpQnaCaptura, 
                             Date fecModifico, String idTercero, 
