...
[keyword][]MONTO_PREST_FIJAS=(182.5 * pago.getFactor() - pago.montoConceptoRetroactivo("P","44") - pago.montoConceptoRetroactivo("P","46") - pago.montoConceptoRetroactivo("P","38"))
[keyword][]MONTO_AYUDA_DESPENSA=(182.5 * pago.getFactor() - pago.montoConceptoRetroactivo("P","38"))
[keyword][]MONTO_PREVISION_SOCIAL=(182.5 * pago.getFactor() - pago.montoConceptoRetroactivo("P","44"))
[keyword][]MONTO_AYUDA_SERVICIOS=(167.5 * pago.getFactor() - pago.montoConceptoRetroactivo("P","46"))
[keyword][]MONTO_AYUDA_TRANSPORTE=(50.0 * pago.getFactor() - pago.montoConceptoRetroactivo("P","95"))
[keyword][]COMP_X_DESA=(600.0 * pago.getFactor() - pago.montoConceptoRetroactivo("P","77"))
...
[keyword][]AYUDA_DESP=(182.50 * pago.getFactor() - pago.montoConceptoRetroactivo("P","38"))
...
[keyword][]TOPE_SDO_BASE=pago.sueldoBase(10093.5 * pago.getFactor())
...
[keyword][]GRAVABLE_OPERATIVO=((pago.getTabSueldo() + pago.getTabCompensacion() + pago.getIncentivo()) / 2.0  + 550.0 + 132.5 * 3.0) * pago.getFactor()
[condition][]-es retroactivo=retroactivo == true
[condition][]-movimiento valido=movimiento == 111 || movimiento == 112 || movimiento == 221 || movimiento == 225 || movimiento == 113 || movimiento == 503 || movimiento == 513
...
[keyword][]TOPE_SDO_BASE_PATRON=pago.sueldoBasePatron(10093.5 * pago.getFactor())
...
[keyword][]PRIMA_VAC_EXCENTA=(67.29 * 7.5)
...
[keyword][]SDO_BASE_PATRON=(pago.sueldoBasePatron(10093.5 * pago.getFactor() + 1))
