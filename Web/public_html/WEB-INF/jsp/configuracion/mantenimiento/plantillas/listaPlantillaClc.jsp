...
<html:form modelAttribute="plantillaDTO" method="post">
        ...
        <tr>
            <td align="center">
                <display:table name="plantillaDTO.listaFile" 
                               ...
                               sort="list"  >
                    <display:column href="/sireh/mantenimientoPlantillaClc/getFilePlantillaClc.do" 
                                    paramId="nameFile"  
                                    property="valor"
                                    titleKey="sireh.label.configuracion.manto.plantillas.clc.plantilla">
                        <img align="center" src="<spring:theme code="edit.gif"/>" alt="Editar" width="18" height="18"/><c:out value='${row.valor}'/>
                    </display:column>                              
                    <display:column titleKey="sireh.label.configuracion.manto.plantillas.clc.plantilla.eliminar">
    ...
    <table width="100%">
        <tr align="right">
            <td><fsn:submit value="submit.create" action="mantenimientoPlantillaClc/altaPlantilla" progressBar="true"/></td>
        </tr>
    </table>
</html:form>