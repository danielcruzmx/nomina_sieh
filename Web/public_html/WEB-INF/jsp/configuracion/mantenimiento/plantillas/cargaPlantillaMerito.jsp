...
<html:form modelAttribute="plantillaDTO" method="post" enctype="multipart/form-data">
   ...
   |<table width="80%">
          <tr>   
            <td class="label"><spring:message code="sireh.label.configuracion.manto.plantillas.merito.archivo.nombre"></spring:message></td>
            <td><fsn:label path="nameFile" /></td>            
        </tr>
         <tr>   
            <td class="label"> * <spring:message code="sireh.label.configuracion.manto.plantillas.merito.archivo"></spring:message></td>
    ...
    <table width="100%">
        <tr align="right">
            <td><fsn:submit value="submit.upload" action="mantenimientoPlantillaMerito/${plantillaDTO.urlDestino}" progressBar="true"/></td>
        </tr>
    </table>
</html:form>