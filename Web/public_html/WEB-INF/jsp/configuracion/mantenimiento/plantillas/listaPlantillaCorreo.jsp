...
<html:form modelAttribute="plantillaDTO" method="post">
    ...
    <table align="center">
        <tr>
            <td align="center">
               <display:table name="plantillaDTO.listaFile"
                              class="displaytag" 
                              pagesize="10" 
                              id="row"
                              requestURI="${requestURI}" 
                              sort="list"  >
                     <display:column href="/sireh/mantenimientoPlantillaCorreo/getFilePlantillaCorreo.do" 
                                     paramId="nameFile" 
                                     property="valor" 
                                     titleKey="sireh.label.configuracion.manto.plantillas.correo.plantilla" >
                        <img align="center" src="<spring:theme code="edit.gif"/>" alt="Editar" width="18" height="18"  /><c:out value='${row.valor}'/>
                    </display:column>                              
                    <display:column titleKey="sireh.label.configuracion.manto.plantillas.correo.plantilla.eliminar">
    ...
    <table width="100%">
        <tr align="right">
            <td><fsn:submit value="submit.create" action="mantenimientoPlantillaCorreo/altaPlantilla" progressBar="true"/></td>
        </tr>
    </table>
</html:form>