...
<html:form modelAttribute="controlExpedientesDTO">
    ...
    <h1><spring:message code="sireh.label.oficinaVirtual.gestionDocumentos.faltantesLaborales.title"/></h1>
    <p>&nbsp;</p>
                            ...
                            <fsn:pagedList beanName="${controlExpedientesDTO.beanName}" 
                                ...
                                <div id="displayTagDiv" style="width:1000px;overflow:auto;"> 
                                    <display:table name="${controlExpedientesDTO.beanName}" 
                                                   ...
                                                   sort="list">                                        
                                        <display:column titleKey="sireh.label.oficinaVirtual.gestionDocumentos.busquedaFaltantesLaborales.consulta.unidad" 
                                                        property="descUnidad" 
                                                        sortable="true"/>
                                        <display:column titleKey="sireh.label.oficinaVirtual.gestionDocumentos.busquedaFaltantesLaborales.consulta.rfcEmpleado" 
                                                        property="rfcEmpleado" 
                                                        sortable="true"
                                                        href="faltantesLaboralesBusqueda.do" 
                                                        paramId="rfcEmpleado"/>
                                        <display:column titleKey="sireh.label.oficinaVirtual.gestionDocumentos.busquedaFaltantesLaborales.consulta.nombreEmpleado" 
                                                        property="nombreEmpleado" 
                                                        sortable="true"/>
                                        <display:column titleKey="sireh.label.oficinaVirtual.gestionDocumentos.busquedaFaltantesLaborales.consulta.primerApellido" 
                                                        property="primerApellido" 
                                                        sortable="true"/>
                                        <display:column titleKey="sireh.label.oficinaVirtual.gestionDocumentos.busquedaFaltantesLaborales.consulta.segundoApellido" 
                                                        property="segundoApellido" 
                                                        sortable="true"/>
                                        <display:column titleKey="sireh.label.oficinaVirtual.gestionDocumentos.busquedaFaltantesLaborales.consulta.descPuesto" 
                                                        property="descPuesto" 
                                                        sortable="true"/>
        ...
        <tr align="center">
            <td>
                <c:if test="${not empty controlExpedientesDTO.rfcEmpleadoBusqueda}">
                    <fsn:docElectronica rfc="${controlExpedientesDTO.rfcEmpleadoBusqueda}" tipo="FALTANTES_LABORALES"/>
                </c:if>
            </td>
        </tr>
    </table>
