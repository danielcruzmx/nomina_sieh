            ...
            <fieldset style='border-style:outset; border-width: <c:out value="${expedienteDTO.gruesolinea}"/>; border-color: <c:out value="${expedienteDTO.colormarco}"/>;'>
                ...
                <table width="100%">
                    ...
                    <tr align="left">
                        ...
                        <td align="left" width="250">  <fsn:label path="idPlaza"/> - <fsn:label path="descSitPlaza"/> - <fsn:label path="descNombramientoNom"/>&nbsp;<fsn:detalleCalculoNomina name="plaza" plaza="${expedienteDTO.idPlaza}" image="detail.gif" /> </td>
                    ...
                    <tr align="left">
                        <td class="label" width="250"> <spring:message code="sireh.label.expediente.plazaIniCont"></spring:message> </td>
                        <td align="left" width="250">  <fsn:label path="plazaIniCont"/> - <fsn:label path="plazaFinCont"/> </td>
                        <td class="label" width="250"> <spring:message code="sireh.label.expediente.plazaIniLic"></spring:message> </td>
                        <td align="left" width="250">  <fsn:label path="plazaIniLic"/> - <fsn:label path="plazaFinLic"/> </td>
                    </tr>
                    <tr align="left">
                        <td class="label" width="250"> <spring:message code="sireh.label.expediente.descMovsPersonalEmp"></spring:message> </td>
                        <td align="left" width="250">  <fsn:label path="descMovsPersonalEmp"/> - Vigencia: <fsn:label path="plazaUltimoMovto"/> </td>
