...
<html:form modelAttribute="ruspBajaDTO">
    ...
    <h1><strong>
            ...
            <spring:message code="gestion.archivodatos"/>
    </strong></h1>
                    ...
                    <table width="100%" align="center" border="0">
                        ...
                        <tr> 
                            ...
                            <td align="left" colspan="2">
                                ...
                                <fsn:selectList beanName="tdCiclos-Datos-Rusp"
                                                path="rbCiclo"/>
                            </td>
                        </tr>
                        <tr> 
                            ...
                            <td align="left" colspan="2">
                                <fsn:option key="0" value="selectList.nonValue"/>
                                <fsn:selectList beanName="tdQuincenas-Datos-Rusp"  
                                                path="rbQnaPago"
                                                progress="true"
                                                parentPath="rbCiclo"
                                                style="width: 100px;"/>
          ...
          <tr align="center">
              <td>
                  <fsn:submit value="submit.accept" 
                              path="muestraReporte"
                              action="gestionRusp/interfazDatosPersonales.do"
                              progressIcon="false"/>
        ...
        <table>
            ...
            <tr>
                ...
                <fsn:report provider="jasper" 
                            viewUri="/rusp/datos_personales"
                            imagesUri="/images/reports" 
                            format="pdf" 
                            fileName="datos_personales"
             ...
             <tr>
                 <td align="center" width="60%">
                   <fsn:submit value="genera" 
                               path="genera"
                               action="gestionRusp/generaDatosPersonales.do"
                               progressIcon="false"/>
                 </td>
             </tr>
        </table>
