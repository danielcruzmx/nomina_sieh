...
<html:form modelAttribute="consultaEmpleadoDTO">
    ...
    <table width="100%">
        <tr align="right">
            <td><fsn:submit value="submit.search" action="gestionRusp/${consultaEmpleadoDTO.urlOrigen}"/></td>
        </tr>
    </table>
    ...
    <fsn:pagedList beanName="EmpleadosHis" baseUrl="${consultaEmpleadoDTO.urlOrigen}" maxRows="200">
        <display:table name="EmpleadosHis" class="displaytag" pagesize="10" export="true" id="row" requestURI="${requestURI}" sort="list">
