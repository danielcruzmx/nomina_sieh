...
<html:form modelAttribute="ruspDTO">
    ...
    <h1><strong>
            ...
            <spring:message code="gestion.bajaRusp"/>
    </strong></h1>
            ...
            <td align="center">
                <table align="center" width="100%" border="0">
                    <tr>
                        ...
                        <td align="right" width="30%"><fsn:submit value="submit.accept" path="muestraReporte" action="gestionRusp/pBajas.do"/></td>
                        <td width="5%">&nbsp;</td>
                        <td align="left" ><fsn:submit value="submit.clean" path="limpiar" action="gestionRusp/pBajas.do"/></td>
                        <td >&nbsp;</td>
                    </tr>
                </table>
            </td>
