...
<h1><spring:message code="sireh.label.merito.archivoCapacitacion.titulo"/></h1>
    <p>&nbsp;</p>
                    ...
                    <table width="90%" align="center" border="0">
                        ...
                        <tr>    
                            ...
                            <td colspan="2" align="left"><fsn:option key="0" value="selectList.nonValue" />
                                <fsn:selectList beanName="tcMaxRemesaCapacitacionPorCiclo" path="tdNmhOp"  progress="true" parentPath="tdNmhCiclo"  /></td>
                         </tr>
                        <tr>   
