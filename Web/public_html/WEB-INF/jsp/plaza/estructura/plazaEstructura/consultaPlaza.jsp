...
<html:form modelAttribute="consultaPlazaDTO">
                ...
                <fieldset>
                    ...
                    <table width="80%">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <fsn:option key="" value="selectList.nonValue"/>
                                <fsn:selectList beanName="tcUnidadBusqueda" 
                                                path="idUnidadPre"/>
                            </td>
                        </tr>
                    </table>
    ...
    <table width="100%">
        <tr align="center">
            <td>
                <c:if test="${consultaPlazaDTO.eliminaPlazaSoporte && consultaPlazaDTO.muestraRegistros}">
                        <fsn:submit value="submit.delete" 
                                path="eliminaPlazaSoporte" 
                                action="plazaEstructura/${consultaPlazaDTO.urlOrigenEliminaPlaza}" 
                                alertCode="confirm.multiple.delete"/>&nbsp;
                </c:if>
                <fsn:submit value="submit.search" 
                            path="muestraRegistros" 
                            action="plazaEstructura/${consultaPlazaDTO.urlOrigen}"/>&nbsp;
            ...
            <fsn:pagedList beanName="${consultaPlazaDTO.beanName}" 
                ...
                <div id="displayTagDiv">
                    <display:table name="${consultaPlazaDTO.beanName}" 
                                   ...
                                   sort="list">
                        <c:choose>
                            <c:when test="${consultaPlazaDTO.eliminaPlazaSoporte}">
                        ...
                        <display:column titleKey="sireh.label.plaza.consulta.liberaPlaza.idSituacionPlaza" 
                                        ...
                                        sortable="true"/>
                        <c:if test="${consultaPlazaDTO.eliminaPlazaSoporte}">
                            <display:column titleKey="sireh.label.plaza.consulta.liberaPlaza.plazaRespaldo" 
                                            property="plazaRespaldo" 
                                            sortable="true"/>
                        </c:if>
