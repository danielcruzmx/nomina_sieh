...
<html:form modelAttribute="cambioPtoFisicoPlazaDTO">
    ...
    <spring:message code="sireh.label.plaza.estructura.cambioPtoFisicoPlaza.titulo"/></h1>
    <p>&nbsp;</p>
    ...
    <table align="center" width="100%" border="0">
        ...
        <tr>
            <td>
                <fieldset>
                    <legend style="font-size:1.3em">
                        <strong>&nbsp;&nbsp;<spring:message code="sireh.label.plaza.estructura.cambioPtoFisicoPlaza.titulo"/>&nbsp;&nbsp;</strong>
                    </legend>
                    <table align="center" width="100%" border="0">
                        <colgroup>
                            <col width="20%"/>
        ...
        <tr>
            <td align="center">
                <c:if test="${cambioPtoFisicoPlazaDTO.verificar}">
                    <fsn:submit value="submit.accept" action="plazaEstructura/updateCambioPtoFisicoPlaza.do"/>&nbsp;
                </c:if>
                <fsn:submit value="submit.verify" path="verificar" action="plazaEstructura/verificaCambioPtoFisicoPlaza.do"/>&nbsp;
                <fsn:submit value="submit.cancel" path="cancel" action="plazaEstructura/consCambioPtoFisicoPlaza.do"/>
            </td>
        </tr>
    </table>
</html:form>