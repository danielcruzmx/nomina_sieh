...
<html:form modelAttribute="cambioSitPlazaDTO">
    ...
    <spring:message code="sireh.label.plaza.estructura.cambioSitPlaza.titulo"/></h1>
    <p>&nbsp;</p>
    ...
    <table align="center" width="100%" border="0">
        ...
        <tr>
            <td>
                <fieldset>
                    <legend style="font-size:1.3em">
                        <strong>&nbsp;&nbsp;<spring:message code="sireh.label.plaza.estructura.cambioSitPlaza.titulo"/>&nbsp;&nbsp; </strong>
                    </legend>
                    <table align="center" width="100%" border="0">
                        <colgroup>
                            <col width="20%"/>
        ...
        <tr>
            <td>
                <table align="center" width="100%" border="0">
                    <tr>
                        <td align="right">
                            <fsn:submit value="submit.accept" action="plazaEstructura/updateCambioSitPlaza.do"/>
                        </td>
                        <td align="left">
                            <fsn:submit value="submit.cancel" path="cancel" action="plazaEstructura/consultaCambioSitPlaza.do"/>
                        </td>
                    </tr>
                </table>
            </td>
