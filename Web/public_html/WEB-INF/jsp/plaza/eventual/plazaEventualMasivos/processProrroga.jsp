...
<html:form name="checkBoxTest" modelAttribute="prorrogaMasivaDTO" action="processProrroga.do">
    ...
    <h1><spring:message code="sireh.label.plaza.masivas.eventuales.prorroga.titulo"/></h1>  
    <p>&nbsp;</p>
            ...
            <td>
                ...
                <table width="100%" align="center">
                    <c:if test="${prorrogaMasivaDTO.muestraRegistros}" >
                        <tr>
                            <td align="center"><fsn:submit value="submit.search" action="plazaEventualMasiva/${prorrogaMasivaDTO.urlOrigen}" path="buscar"/></td>
                        </tr>
                    </c:if>
                    <c:if test="${not prorrogaMasivaDTO.muestraRegistros}">
                       ...
                       <tr>
                           <td align="right"><fsn:submit value="submit.search" action="plazaEventualMasiva/${prorrogaMasivaDTO.urlOrigen}" path="buscar"/></td>
                           <td align="left"><fsn:submit value="submit.clean" action="plazaEventualMasiva/${prorrogaMasivaDTO.urlOrigen}" path="cancel"/></td>
                        </tr>
                    </c:if>
                </table>
                <c:if test="${prorrogaMasivaDTO.muestraRegistros}" >
                    <fieldset>
                        <legend>
                            <strong>&nbsp;&nbsp;<spring:message code="sireh.label.plaza.masivas.eventuales.prorroga.titulo.prorroga"/>&nbsp;&nbsp;</strong>
                        </legend>
                        <table width="100%" align="center" border="0">
                            <tr>   
                                <td class="label"> * <spring:message code="sireh.label.plaza.masivas.eventuales.prorroga.fechaInicioVigencia"></spring:message></td>
                                <td><fsn:calendar path="fechaInicioVigencia" /></td>            
                                <td class="label"> * <spring:message code="sireh.label.plaza.masivas.eventuales.prorroga.fechaProrroga"></spring:message></td>
                                <td><fsn:calendar path="fechaTerminoVigencia" /></td>            
                            </tr>
                            <tr>
                                <td class="label"> * <spring:message code="sireh.label.plaza.masivas.eventuales.prorroga.tipoMovimiento"></spring:message></td>
                                <td><fsn:option key="" value="selectList.nonValue" />
                                <fsn:selectList beanName="tdPlazaTipoMovimientoProrroga" path="tipoMovimiento" /></td>            
                            </tr>
                            <tr>
                                <td class="label"><spring:message code="sireh.label.plaza.masivas.eventuales.prorroga.observaciones"></spring:message></td>
                                <td colspan="3"><fsn:textarea rows="5" cols="100" uppercase="false" path="mepObserva"/> </td>
                            </tr>
                        </table>
                    </fieldset>
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td align="right"><fsn:submit value="submit.prorroga" action="plazaEventualMasiva/${prorrogaMasivaDTO.urlDestino}" path="prorroga" /></td>
                            <td align="left"><fsn:submit value="submit.clean" action="plazaEventualMasiva/${prorrogaMasivaDTO.urlOrigen}" path="cancel"/></td>
                        </tr>
                    </table>
                </c:if>
    ...
    <c:choose>
        <c:when test="${prorrogaMasivaDTO.muestraRegistros}">
            ...
            <fsn:pagedList beanName="tdPlazaProrrogaEventuales" baseUrl="${prorrogaMasivaDTO.urlOrigen}" maxRows="500" checkbox="true" chkProperty="idPlaza" appendFilters="true">
