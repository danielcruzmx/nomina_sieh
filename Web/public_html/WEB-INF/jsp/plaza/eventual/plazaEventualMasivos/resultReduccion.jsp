...
<html:form modelAttribute="reduccionContratoMasivaDTO">
    ...
    <table width="80%">
         <tr>   
            ...
            <td><fsn:link action="plazaEventualMasiva/downloadFile" parameters="nombreArchivoErrores=${reduccionContratoMasivaDTO.nombreArchivoResultados}" progressIcon="false" >
