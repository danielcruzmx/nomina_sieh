...
<html:form modelAttribute="creacionPlazaMasivaDTO"  method="post" enctype="multipart/form-data">
    <h1><spring:message code="sireh.label.plaza.masivas.eventuales.creacion.titulo"/></h1>  
    <p>&nbsp;</p>
    <table width="80%">
         <tr>   
    ...
    <table width="100%">
        <tr align="right">
            <td><fsn:submit value="submit.upload" action="plazaEventualMasiva/${creacionPlazaMasivaDTO.urlDestino}" progressBar="true"/></td>
        </tr>
    </table>
