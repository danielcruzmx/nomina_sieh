...
<html:form name="checkBoxTest" modelAttribute="reduccionContratoMasivaDTO" action="processReduccion.do">
            ...
            <td>
                ...
                <table width="100%" align="center">
                    <c:if test="${reduccionContratoMasivaDTO.muestraRegistros}" >
                        <tr>
                            <td align="center"><fsn:submit value="submit.search" action="plazaHonorarioMasiva/${reduccionContratoMasivaDTO.urlOrigen}" path="buscar"/></td>
                        </tr>
                    </c:if>
                    <c:if test="${not reduccionContratoMasivaDTO.muestraRegistros}">
                       ...
                       <tr>
                           <td align="right"><fsn:submit value="submit.search" action="plazaHonorarioMasiva/${reduccionContratoMasivaDTO.urlOrigen}" path="buscar"/></td>
                           <td align="left"><fsn:submit value="submit.clean" action="plazaHonorarioMasiva/${reduccionContratoMasivaDTO.urlOrigen}" path="cancel"/></td>
                        </tr>
                    </c:if>
                </table>
                <c:if test="${reduccionContratoMasivaDTO.muestraRegistros}" >
                    <fieldset>
                        <legend>
                            <strong>&nbsp;&nbsp;<spring:message code="sireh.label.plaza.masivas.honorarios.reduccion.titulo.reduccion"/>&nbsp;&nbsp;</strong>
                        </legend>
                        <table width="100%" align="center" border="0">
                            <tr>   
                                <td class="label"> * <spring:message code="sireh.label.plaza.masivas.honorarios.reduccion.fechaReduccion"></spring:message></td>
                                <td><fsn:calendar path="fechaTerminoVigencia" /></td>            
                            </tr>
                            <tr>
                                <td class="label"><spring:message code="sireh.label.plaza.masivas.honorarios.reduccion.observaciones"></spring:message></td>
                    ...
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td align="right"><fsn:submit value="submit.reducir" action="plazaHonorarioMasiva/${reduccionContratoMasivaDTO.urlDestino}" path="reduccion" /></td>
                            <td align="left"><fsn:submit value="submit.clean" action="plazaHonorarioMasiva/${reduccionContratoMasivaDTO.urlOrigen}" path="cancel"/></td>
                        </tr>
                    </table>
                </c:if>
    ...
    <c:choose>
        <c:when test="${reduccionContratoMasivaDTO.muestraRegistros}">
            ...
            <fsn:pagedList beanName="tdPlazaProrrogaHonorarios" baseUrl="${reduccionContratoMasivaDTO.urlOrigen}" maxRows="500" checkbox="true" chkProperty="idPlaza" appendFilters="true">
