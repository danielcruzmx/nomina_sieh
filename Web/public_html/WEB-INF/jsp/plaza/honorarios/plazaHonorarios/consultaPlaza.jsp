...
<html:form name="checkBoxTest" modelAttribute="consultaPlazaDTO">
                ...
                <fieldset>
                    ...
                    <table width="80%">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${consultaPlazaDTO.prorrogaContratoHonorarios}">
                                        <c:out value="Ocupada"/>
                                    </c:when>
                                    <c:otherwise>
            ...
            <td>
                <c:if test="${consultaPlazaDTO.depura && consultaPlazaDTO.muestraRegistros}">
                    <fsn:submit value="submit.delete" 
                                path="depura" 
                                action="plazaHonorarios/${consultaPlazaDTO.urlOrigenDepura}" 
                                alertCode="confirm.multiple.delete"/>&nbsp;
                </c:if>
                <fsn:submit value="submit.search" 
                            path="muestraRegistros" 
                            action="plazaHonorarios/${consultaPlazaDTO.urlOrigen}"/>&nbsp;
    ...
    <c:if test="${consultaPlazaDTO.depura && consultaPlazaDTO.muestraRegistros}">
        ...
        <div align="center" style="vertical-align:middle; height:60px">
            Observaciones: <fsn:textarea path="observaciones" rows="4" cols="60"/>
        </div>
    </c:if>
