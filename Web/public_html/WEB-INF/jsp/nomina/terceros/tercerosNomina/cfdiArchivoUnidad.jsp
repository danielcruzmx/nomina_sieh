...
<html:form  modelAttribute="cfdiArchivoDTO">

    <h1> <strong> <spring:message code="sireh.label.terceros.sat.impresion.cfdi.pdf.titulo"/> </strong> </h1> 
    <p>&nbsp;</p>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <fsn:submit value="submit.search" 
                                                        path="buscar" 
                                                        action="tercerosNomina/cfdiArchivoUnidad.do"/>
                                        </td>
                                        <c:if test="${cfdiArchivoDTO.muestraRegistros eq false}">
                                            <td align="left">
                                        ...
                                        <c:if test="${cfdiArchivoDTO.muestraRegistros}">
                                            <td align="center">
                                                <fsn:submit value="submit.clean" 
                                                            path="limpiar" 
                                                            action="tercerosNomina/cfdiArchivoUnidad.do"/>
                                        ...
                                        <c:if test="${cfdiArchivoDTO.muestraRegistros}">
                                            <td align="left">
                                                <fsn:submit value="submit.generate" 
                                                            path="procesar"
                                                            action="tercerosNomina/getArchivosUnidadPdf.do"
                                                            progressIcon="false" />
                                            </td>
                                        </c:if>
                                    </tr>
    ...
    <c:choose>
        <c:when test="${cfdiArchivoDTO.muestraRegistros}">
            ...
            <fsn:pagedList beanName="${cfdiArchivoDTO.beanName}"
                           checkbox="true"
                           chkProperty="idGrupo"
                           baseUrl="${cfdiArchivoDTO.urlOrigen}"
                           appendFilters="false">
                <div id="displayTagDiv" style="text-align:center;width:1000px;height:500px;overflow:auto;">
                    <display:table name="${cfdiArchivoDTO.beanName}" 
                                   class="displaytag"
