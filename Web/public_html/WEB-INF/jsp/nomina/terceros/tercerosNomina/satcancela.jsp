...
<html:hidden path="qnaCapturaRequired"/>
    ...
    <table width="100%" align="center" border="0">
        <tr>
            <td>
                <h1> <strong> <spring:message code="sireh.label.nomina.terceros.satcancela.header"/> </strong> </h1> 
                <p>&nbsp;</p>
            </td>   
        </tr>
        <tr> <td> </td> </tr>
        <tr>
            ...
            <tr>
                <td align="center">
                       <fsn:submit value="submit.generate" path="generaArchivo" action="tercerosNomina/generaArchivosatcancela.do" progressIcon="false" />
                       <fsn:submit value="submit.clean" path="cancel" action="tercerosNomina/satcancela.do"/>
