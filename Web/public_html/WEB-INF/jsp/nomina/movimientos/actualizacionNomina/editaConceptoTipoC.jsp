...
<html:form name="agrCptsO" id="agrCptsO" modelAttribute="datosEmpleadoCptoDTO">
                ...
                <fieldset>
                    ...
                    <table align="center" width="90%">
                        ...
                        <tr>
                            ...
                            <td align="left"><fsn:label path="idTipoCpto" id="idTipoCpto"/>
                            <fsn:label path="idConcepto" id="idConcepto"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<fsn:label path="cpcTipoCaptura"/><fsn:label path="cpcTipoCalculo"/><fsn:label path="cpcPermanente"/><fsn:label path="cpcSubTipo"/></td>
                        </tr>
                        <tr>
                ...
                <fieldset>
                    ...
                    <table align="center" width="90%">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${datosEmpleadoCptoDTO.idTipoCpto == 'D' && datosEmpleadoCptoDTO.idConcepto == '83'}">
                                <table align="center" width="100%">
                                    <tr>
                                ...
                                <c:if test="${(datosEmpleadoCptoDTO.idTipoCpto == 'D' && datosEmpleadoCptoDTO.idConcepto == '29') || (datosEmpleadoCptoDTO.idTipoCpto == 'D' && datosEmpleadoCptoDTO.idConcepto == 'LP')}">
                                <table align="center" width="100%">
                                    <tr>
                                ...
                                <c:if test="${(datosEmpleadoCptoDTO.idTipoCpto == 'P' && datosEmpleadoCptoDTO.idConcepto == 'T0') ||
                                              ...
                                              (datosEmpleadoCptoDTO.idTipoCpto == 'P' && datosEmpleadoCptoDTO.idConcepto == 'TD')  }">
                                <table align="center" width="100%">
                                    <tr>
                                ...
                                <c:if test="${(datosEmpleadoCptoDTO.idTipoCpto == 'P') && (datosEmpleadoCptoDTO.idConcepto == 'PD')}">
                                <table align="center" width="100%">
                                    <tr>
                                        <td align="right" class="label">*&nbsp;<spring:message code="sireh.label.nomina.movimientos.actualizacionNomina.actualizacionConceptos.generales.dias"/></td>
                                        <td align="left"><html:input path="mcpHorasDiasLabel" id="mcpHorasDiasLabel"/></td>
                                ...
                                <c:if test="${(datosEmpleadoCptoDTO.idTipoCpto == 'P' && datosEmpleadoCptoDTO.idConcepto == 'NM') ||
                                              (datosEmpleadoCptoDTO.idTipoCpto == 'P' && datosEmpleadoCptoDTO.idConcepto == 'PC') }">
                                <table align="center" width="100%">
                                    <tr>
                                        <td align="right" class="label">*&nbsp;<spring:message code="sireh.label.nomina.movimientos.actualizacionNomina.actualizacionConceptos.generales.dias"/></td>
                                        <td align="left"><html:input path="mcpHorasDiasLabel" id="mcpHorasDiasLabel"/></td>
    ...
    <table align="center" width="80%">
         ...
         <tr>
            ...
            <td align="left" width="40%"><fsn:submit value="submit.cancel" path="cancel" action="${uri}"/></td>
        </tr>
    </table>
    ...
    <html:hidden path="valida"          id="valida"/> <!--porque se duplica la el no de quincenas al guardar-->
