...
<html:form modelAttribute="consultaEmpleadoDTO">
    <h1><spring:message code="tdEmpleadoDTO.consultaEmpleado.title" arguments="${consultaEmpleadoDTO.menuTitle}"></spring:message></h1>
    <p>&nbsp;</p>
    <table width="80%">
        <tr align="left">
    ...
    <table width="100%">
        <tr align="right">
            <td><fsn:submit value="submit.search" action="cambioNomina/${consultaEmpleadoDTO.urlOrigen}"/></td>
        </tr>
    </table>
