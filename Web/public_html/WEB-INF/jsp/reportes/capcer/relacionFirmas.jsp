...
<html:form modelAttribute="reportesCapcerDTO">
    ...
    <h1><spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.title"/></h1>
    <p>&nbsp;</p>
            ...
            <td colspan="3">
                <fieldset>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" width="99%">
                        <tr align="left">
                            <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.tipoBusqueda"/>:</td>
                            <td align="left">
            ...
            <td valign="top" align="left" style="vertical-align: top">
                <fieldset id="fieldsetPorCurso">
                    ...
                    <table width="100%">
                        <tbody>
                            <tr align="left">
                                <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.ciclo"/>:</td>
                                <td colspan="3">                                    
                                    <fsn:option key="0" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-ciclo-reportes-relacionFirmas"  
                                                    path="cicloEjeTematico"
                                                    style="width: 250px;"/>
                                </td>
                            </tr>
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.subprograma"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-subprograma-reportes-relacionFirmas"  
                                                    path="idSubprograma"
                                                    progress="true"
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.ejeTematico"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-ejeTematico-reportes-relacionFirmas"  
                                                    path="idEjeTematico"
                                                    progress="true"
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.modalidad"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-modalidad-reportes-relacionFirmas"  
                                                    path="idModalidad"
                            ...
                            <tr align="left">
                                <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.curso"/>:</td>
                                <td>
                                    <fsn:option key="0" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-curso-reportes-relacionFirmas"  
                                                    path="idCurso"
                                                    progress="true"
            ...
            <td valign="top" align="left" style="vertical-align: top">
                <fieldset id="fieldsetPorClave">
                    ...
                    <table width="100%">
                        <tbody>
                            <tr align="left">
                                <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.relacionFirmas.claveCurso"/>:</td>
                                <td>
        ...
        <tr>
            <td align="right">
                <fsn:submit value="submit.accept" 
                            path="muestraReporte"
                            action="reportesCursoSPC/relacionFirmas.do"/>
            </td>
            <td align="left">
                ...
                <td align="left">
                    ...
                    <fsn:reportParam name="P_CVE_CURSO" value="${reportesCapcerDTO.cursoClave}"/>
                        <fsn:report provider="jasper" 
                                    viewUri="/capcer/relacionFirmas" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="relacionFirmas" 
