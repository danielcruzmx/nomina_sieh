...
<html:form modelAttribute="reportesCapcerDTO">
    ...
    <h1><spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.title"/></h1>
    <p>&nbsp;</p>
            ...
            <td colspan="3">
                <fieldset>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" width="99%">
                        <tr align="left">
                            <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.tipoBusqueda"/>:</td>
                            <td align="left">
            ...
            <td valign="top" align="left" style="vertical-align: top">
                <fieldset id="fieldsetPorCurso">
                    ...
                    <table width="100%">
                        <tbody>
                            <tr align="left">
                                <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.ciclo"/>:</td>
                                <td colspan="3">                                    
                                    <fsn:option key="0" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-ciclo-reportes-informeCurso"  
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.coordinacionAdministrativa"/>:</td>
                                <td colspan="3">
                                    <fsn:option key="0" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-coordinacionAdministrativa-reportes-informeCurso"  
                                                    path="idUnidadCoord"
                                                    progress="true"
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.subprograma"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-subprograma-reportes-informeCurso"  
                                                    path="idSubprograma"
                                                    progress="true"
                                                    parentPath="cicloEjeTematico" 
                                                    style="width: 250px;"/>
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.ejeTematico"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-ejeTematico-reportes-informeCurso"  
                                                    path="idEjeTematico"
                                                    progress="true"
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.modalidad"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-modalidad-reportes-informeCurso"  
                                                    path="idModalidad"
                            ...
                            <tr align="left">
                                <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.curso"/>:</td>
                                <td>
                                    <fsn:option key="0" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tnCapCurso-curso-reportes-informeCurso"  
                                                    path="idCurso"
                                                    progress="true"
            ...
            <td valign="top" align="left" style="vertical-align: top">
                <fieldset id="fieldsetPorClave">
                    ...
                    <table width="100%">
                        <tbody>
                            <tr align="left">
                                <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.informeCurso.claveCurso"/>:</td>
                                <td>
            ...
            <td align="right">
                <c:if test="${reportesCapcerDTO.rolAdministradorCapacitacion || reportesCapcerDTO.rolOperadorCapacitacion}"> 
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reportesCursoSPC/informeCurso.do"/>
                </c:if>
            </td>
            <td align="left">
                ...
                <td align="left">
                    <c:if test="${reportesCapcerDTO.rolAdministradorCapacitacion || reportesCapcerDTO.rolOperadorCapacitacion}">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/capcer/informeCurso" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="informeCurso" 
