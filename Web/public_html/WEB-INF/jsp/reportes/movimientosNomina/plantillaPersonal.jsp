...
<html:form modelAttribute="reportesMovtoNominaDTO">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="reporte.movimientos.nomina.plantilla.personal"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
                        ...
                        <tr>
                            <td align="right">
                                <fsn:submit value="submit.accept" 
                                            path="muestraReporte"
                                            action="reporteMoviminentos/plantillaPersonal.do"/>
                            </td>
                            <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/movimientosNomina/plantillaPersonal" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="plantillaPersonal" 
