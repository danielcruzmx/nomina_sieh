...
<html:form modelAttribute="reportesMovtoNominaDTO">
    ...
    <spring:message code="sireh.label.movimiento.nomina.reportes.vacacionalno.detalle.titulo.link"/>
            </strong>
    </h1>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteMoviminentos/primaVacacionalNoCon.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/movimientosNomina/primaVacacionalNoCon" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="primaVacacionalNoCon" 
