...
<html:form modelAttribute="reportesMovtoNominaDTO" action="constanciaNombramiento.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.movimiento.nomina.reportes.constancia.detalle.titulo.link"/>
        </strong>
    </h1>
    ...
    <div align="center">
        <table width="50%">
            ...
            <tr>
                <td colspan="2" align="left">
                    <fsn:submit value="submit.search" 
                                action="reporteMoviminentos/constanciaNombramiento.do"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="left">
                    ...
                    <fsn:pagedList beanName="listadoMovimientosConstanciaNombramiento"
                                   baseUrl="constanciaNombramiento"
                                   appendFilters="false">
                                   
                        <display:table name="listadoMovimientosConstanciaNombramiento" 
                                       class="displaytag" 
                                       pagesize="10"
                                       export="false" 
                                       id="row" 
                            ...
                            <display:column style="text-align: center;"
                                            ...
                                            sortable="true">
                                <a href="constanciaNombramientoObservaciones.do?idMovtoEmpPla=<c:out value='${row.idMovtoEmpPla}'/>&rfcEmpleado=<c:out value='${reportesMovtoNominaDTO.rfcEmpleado}'/>">
            ...
            <tr>
                ...
                <c:if test="${ reportesMovtoNominaDTO.idMovtoEmpPla != null }">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteMoviminentos/constanciaNombramientoReporte.do"/>
                </c:if>
                </td>
                <td align="left">
        ...
        <c:if test="${ reportesMovtoNominaDTO.muestraReporte }">
            <table>
                ...
                <tr>
                    <td align="left">
                        <fsn:reportParam name="PAR_ID_MOVTO" value="${reportesMovtoNominaDTO.idMovtoEmpPla}"/>
                        <fsn:report provider="jasper" 
                                    viewUri="/movimientosNomina/constanciaNombramiento" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="constanciaNombramiento" 
