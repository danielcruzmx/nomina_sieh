...
<html:form modelAttribute="reportesMovtoNominaDTO" action="datosPersonales.do">
    <h1>
        <strong>
    ...
    <spring:message code="sireh.label.movimiento.nomina.reportes.personales.detalle.titulo.link"/>
            </strong>
    </h1>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteMoviminentos/datosPersonales.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/movimientosNomina/datosPersonales" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="datosPersonales" 
