...
<html:form modelAttribute="reportesMovtoNominaDTO" action="situacionPlazasRFC.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.movimiento.nomina.reportes.plazaRFC.detalle.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteMoviminentos/situacionPlazasRFC.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left" style="z-index: 1;">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/movimientosNomina/situacionPlazasRFC" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="situacionPlazasRFC" 
