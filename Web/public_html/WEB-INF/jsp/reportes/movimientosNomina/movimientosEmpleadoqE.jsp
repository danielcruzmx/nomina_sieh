...
<html:form modelAttribute="reportesMovtoNominaDTO" action="movimientosEmpleadoqE.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.movimiento.nomina.reportes.movimiento2.detalle.quincena.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
                        ...
                        <tr>
                            <td align="right">
                                <fsn:submit value="submit.accept" 
                                            path="muestraReporte"
                                            action="reporteMoviminentos/movimientosEmpleadoqE.do"/>
                            </td>
                            <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/movimientosNomina/movimientosEmpleadoqExt" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="movimientosEmpleadoqExt" 
