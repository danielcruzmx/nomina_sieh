...
<html:form modelAttribute="reportePlazaDTO">
    ...
    <spring:message code="sireh.label.plaza.reportes.ac02.jerarquia.titulo.link"/>
            </strong>
    </h1>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reportePlaza/ac02Jerarquia.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">                    
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="plaza/ac02Jerarquia" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="ac02Jerarquia" 
