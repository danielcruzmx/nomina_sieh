...
<html:form modelAttribute="reportePlazaDTO">
    ...
    <h1><strong>
            ...
            <spring:message code="sireh.label.plaza.reportes.pntbajas.titulo.link"/>
    </strong></h1>
    ...
    <table width="100%" align="center" border="0">
        ...
        <tr align="center">
            <td align="center" colspan="8">
                <fsn:submit value="submit.accept" path="muestraReporte" action="reportePlaza/pntbajas.do" progressIcon="false"/>
