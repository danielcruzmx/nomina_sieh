...
<%--    <html:hidden path="uniCicloRequired"/> --%>
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.plaza.reportes.potHonorarios.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reportePlaza/potHonorarios.do"/>
                </td>
                <td align="left">
...
<!--                        <fsn:reportParam name="PAR_CICLO" value="${reportePlazaDTO.uniCiclo}"/> -->
                        ...
                        <fsn:report provider="jasper" 
                                        viewUri="/plaza/potHonorarios" 
                                        imagesUri="/images/reports"  
                                        format="pdf" 
                                        fileName="potHonorarios" 
