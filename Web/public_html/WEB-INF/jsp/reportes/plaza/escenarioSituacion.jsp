...
<html:form modelAttribute="reportePlazaDTO">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.plaza.reportes.escenario.situacion.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reportePlaza/escenarioSituacion.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/plaza/escenarioSituacion" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="escenarioSituacion" 
