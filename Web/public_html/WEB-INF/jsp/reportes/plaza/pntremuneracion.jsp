...
<html:form modelAttribute="reportePlazaDTO">
    ...
    <h1><strong>
            ...
            <spring:message code="sireh.label.plaza.reportes.pntremuneracion.titulo.link"/>
    </strong></h1>
                    ...
                    <table width="90%" align="center">
                        ...
                        <tr> 
                            ...
                            <td align="left" colspan="2">
                                ...
                                <fsn:selectList beanName="listaQuincenasAnteriores"  path="qnaCaptura" progress="false"/>
                            </td>
                        </tr>
                        <tr>
        ...
        <tr align="center">
            <td align="center" colspan="8">
                <div id="displayTagDiv">
                    <fsn:submit value="submit.accept" path="muestraReporte" action="reportePlaza/descargaPntremuneracion.do" progressIcon="false"/>
                </div>                
            </td>
        </tr>
