...
<html:form modelAttribute="reportesCalculoNominaDTO" action="firmas.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.calculo.reportes.firmas.detalle.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    ...
    <div align="center">
        <table>
            ...
            <tr>
                ...
                <td align="left">
                    <html:select path="pension" cssClass="uppercase">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/firmas.do"/>
                </td>
                <td align="left">
        ...
        <c:if test="${ (reportesCalculoNominaDTO.complemento!=null) &&  (reportesCalculoNominaDTO.mesQna!='0') &&  (reportesCalculoNominaDTO.tipoNomina!='0') && (reportesCalculoNominaDTO.pension=='0') }">
            <table>
                <tr>
                    <th align="left"></th>
                </tr>
            ...
            <table>
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:reportParam name="PAR_PENSION" value="${reportesCalculoNominaDTO.pension}"/>
                        <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/firmaspension" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="firmaspension" 
                                    export="xls,pdf,csv,rtf,xml,docx,pptx,txt" 
                                    width="1060" 
                                    height="350"/>
                    </td>
