...
<html:form modelAttribute="reportesCalculoNominaDTO">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.calculo.reportes.concentrado.detalle.ef.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/concentradoef.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/concentradoedo" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="concentradoedo" 
