...
<html:form name="checkBoxTest" modelAttribute="generaArchivosTercerosDTO">
    ...
    <h1><strong>
        ...
        <spring:message code="reporte.calculo.nomina.concentradovales"/>
    </strong></h1>
        ...
        <tr>
            <td>
                <fieldset id="quincenasFieldSet">
                    ...
                    <table width="100%" align="center">
                        <tr>
                            <td align="right" class="label">*<spring:message code="sireh.label.reportes.calculo.resumenVales.importe"></spring:message></td>
                            <td align="left">
                                <html:input path="importe" onkeypress="return IsNumber(event);"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <table width="100%" align="center">
                            ...
                            <tr>
                                <td align="right" width="45%">
                                    <fsn:submit value="submit.accept" action="reporteCalculo/concentradoVales.do"  progressIcon="false"/>
                                </td>
                                <td width="10%">&nbsp;</td>
                                <td align="left" width="45%">
                                    <fsn:submit value="submit.clean" path="cancel" action="reporteCalculo/concentradoVales.do"  progressIcon="false"/>
                                </td>
                            </tr>
                    </table>
                </fieldset>
        ...
        <tr><td>
            <c:if test="${generaArchivosTercerosDTO.muestraRegistros}">
                ...
                <table align="center" width="25%" border="0">
                    <tr><td align="center">
                        <fsn:submit value="submit.mostrarReporte" path="muestraReporte" action="reporteCalculo/concentradoVales.do" progressIcon="false" />
                    </td></tr>
                </table>
            </c:if>
        </td></tr>
    ...
    <table align="center" width="100%" border="0">
        <tr><td>
            <c:if test="${generaArchivosTercerosDTO.muestraReporte}">
                ...
                <fsn:reportParam name="P_IMPORTE" value="${generaArchivosTercerosDTO.importe} "/>
                <fsn:report provider="jasper" 
                            viewUri="/calculoNomina/estadisticoVales"
                            imagesUri="/images/reports"
                            format="pdf" 
                            fileName="estadisticoVales"
