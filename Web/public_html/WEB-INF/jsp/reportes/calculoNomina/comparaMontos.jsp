...
<html:form modelAttribute="reportesCalculoNominaDTO" action="comparaMontos.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.calculo.reportes.montos.detalle.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/comparaMontos.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/comparaMontos" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="comparaMontos" 
