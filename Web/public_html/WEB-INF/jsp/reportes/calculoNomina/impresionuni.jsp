...
<html:form modelAttribute="reportesCalculoNominaDTO" action="impresionuni.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="reporte.calculo.nomina.impresionuni"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/impresionuni.do"/>
                </td>
                <td align="left">
                    ...
                    <td align="left">
                        ...
                        <fsn:reportParam name="PAR_TIPO_NOMINA" value="${reportesCalculoNominaDTO.tipoNomina}"/>
                            ...
                            <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/comprobantePagouni" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="impresionComprobantesuni" 
