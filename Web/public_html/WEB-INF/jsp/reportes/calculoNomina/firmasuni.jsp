...
<html:form modelAttribute="reportesCalculoNominaDTO" action="firmasuni.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="reporte.calculo.nomina.firmasuni"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/firmasuni.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/firmasuni" 
