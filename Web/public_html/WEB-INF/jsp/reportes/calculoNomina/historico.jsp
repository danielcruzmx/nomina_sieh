...
<html:form modelAttribute="reportesCalculoNominaDTO" action="historico.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.calculo.reportes.historico.detalle.titulo.link"/>
       </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/historico.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/historico" 
