...
<html:form modelAttribute="reportesCalculoNominaDTO" action="impresionGoo.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="reporte.calculo.nomina.impresiongoo"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteCalculo/impresionGoo.do"/>
                </td>
                <td align="left">
                    ...
                    <td align="left">
                        ...
                        <fsn:reportParam name="PAR_TIPO_NOMINA" value="${reportesCalculoNominaDTO.tipoNomina}"/>
                            ...
                            <fsn:report provider="jasper" 
                                    viewUri="/calculoNomina/comprobantePago_G00" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="impresionComprobantesGoo" 
