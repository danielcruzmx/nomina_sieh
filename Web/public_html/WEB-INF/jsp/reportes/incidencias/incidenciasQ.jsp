...
<html:form name="checkBoxTest" modelAttribute="reportesConstanciasDTO">
    ...
    <h1><strong>
        ...
        <spring:message code="sireh.label.terceros.reportes.titulo.inciencias"/> &#45;
        <spring:message code="sireh.label.terceros.reportes.titulo.inciencias.movs.qna"/>
    </strong></h1>
                ...
                <fieldset>
                    ...
                    <table width="100%" align="center" border="0" >
                        ...
                        <tr>
                            ...
                            <td align="center"><fsn:submit value="submit.accept" path="muestraReporte" action="reporteCalculo/incidenciasQ.do"/> </td>
                            <td align="left"><fsn:submit value="submit.clean" path="cancel" action="reporteCalculo/incidenciasQ.do"/></td>
                        </tr>
                    </table>
                </fieldset>
            </td>
            ...
            <tr>
                <td>
                    ...
                    <fsn:report provider="jasper" 
                            viewUri="/incidenciasPersonal/faltasaplicadasrfc" 
                            imagesUri="/images/reports"
                            format="pdf" 
                            fileName="faltasaplicadasrfc" 
        ...
        <table align="center" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <fsn:report provider="jasper" 
                                viewUri="/incidenciasPersonal/faltasaplicadasporunidad" 
                                imagesUri="/images/reports"
                                format="pdf" 
                                fileName="faltasaplicadasporunidad"
                                export="xls,pdf,csv,rtf,xml,docx,pptx,txt" 
                                width="1060" 
                                height="350"/>
                </td>
