...
<html:form modelAttribute="reporteNotasDeMeritoDTO">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.merito.reportes.empleado.detalle.titulo.link"/>
        </strong>
    </h1>
    <p>&nbsp;</p>
    <div align="center">
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteNotasMerito/repNMEmpleado.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/merito/repNMEmpleado" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="repNMEmpleado" 
