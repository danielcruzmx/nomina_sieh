...
<html:form modelAttribute="reportesTercerosDTO">
    <h1>
      <strong>
       ...
       <spring:message code="sireh.label.terceros.reportes.seguroVidaInstitucionalPago.detalle.titulo.link"/>
    </strong>
    </h1>
    ...
    <div align="center">
        <table width="50%">
            ...
            <tr>
                <td align="right" class="label">* Tipo de Nomina</td>
                <td align="left">
                      <html:select path="tipoNomina" cssClass="uppercase">
                      <html:option value="" label="SELECCIONE"/>
                      <html:option value="O" label="Ordinaria"/>
                      <html:option value="E" label="Extraordinaria"/>
                      </html:select>
                </td>
            </tr>
           </tr>
            ...
            <tr>
                <td align="center">
			           ...
			           path="generaArchivo" 
			 	   action="reporteTercerosNomina/generaArchivoSegInsticional" progressIcon="false" />
                       <fsn:submit value="submit.clean"
				   path="cancel" 
				   action="reporteTercerosNomina/seguroVidaPago.do"/>
                </td>
            </tr>
            <tr>
