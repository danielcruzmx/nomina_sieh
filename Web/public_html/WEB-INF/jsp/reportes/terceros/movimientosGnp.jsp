...
<html:form modelAttribute="gnpDTO" action="movimientosGnp.do">
    ...
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.terceros.reportes.seguroRetiro.gnp.movtos"/>
        </strong>
    </h1>
        <table>
            <tr>
                ...
                <td colspan="2">
                    ...
                    <tr>
                            ...
                            <td align="center" width="33%">
                                <fsn:submit value="submit.accept" path="muestraReporte" action="reporteTercerosNomina/generaMovtosGnp.do" progressIcon="false"/>
                            </td>
                            <td align="left" width="33%">
                                <fsn:submit value="submit.clean" path="cancel" action="reporteTercerosNomina/movimientosGnp.do" progressIcon="false"/>
                            </td>
                        </tr>
                    </table>
                </td>
