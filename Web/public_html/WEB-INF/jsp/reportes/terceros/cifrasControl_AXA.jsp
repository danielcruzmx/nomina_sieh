...
<html:form modelAttribute="reportesTercerosDTO">
    <h1>
        <strong>
            ...
            <spring:message code="sireh.label.terceros.reportes.cifrasControlA.detalle.titulo.link"/>
        </strong>
    </h1>
                        ...
                        <tr>
                            <td align="right">
                                <fsn:submit value="submit.accept" 
                                            path="muestraReporte"
                                            action="reporteTercerosNomina/cifrasDeControlA.do"/>
                            </td>
                            <td align="left">
                    ...
                    <td align="left">
                     <!--  <fsn:reportParam name="PAR_CICLO" value="${reportesTercerosDTO.uniCiclo}"/> -->
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/terceros/cifrasControl_AXA" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="cifrasControlAXA" 
