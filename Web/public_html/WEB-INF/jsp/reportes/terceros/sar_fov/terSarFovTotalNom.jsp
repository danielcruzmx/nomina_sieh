...
<html:form name="checkBoxTest" modelAttribute="generaArchivosTercerosDTO">
    ...
    <h1><strong>
        ...
        <spring:message code="gestionsartotaln.gestion.sartotaln"/>
    </strong></h1>
                        ...
                        <table width="100%" align="center">
                            ...
                            <tr>
                                <td align="right" width="45%">
                                    <fsn:submit value="submit.accept" action="reporteTercerosNomina/terSarFovTotalNom.do"  progressIcon="false"/>
                                </td>
                                <td width="10%">&nbsp;</td>
                                <td align="left" width="45%">
                                    <fsn:submit value="submit.clean" path="cancel" action="reporteTercerosNomina/terSarFovTotalNom.do"  progressIcon="false"/>
                                </td>
                            </tr>
                    </table>
                </fieldset>
        ...
        <tr>
            ...
            <c:if test="${generaArchivosTercerosDTO.muestraRegistros}">
                ...
                <table align="center" width="25%" border="0">
                    <tr><td align="center">
                        <fsn:submit value="submit.mostrarReporte" path="muestraReporte" action="reporteTercerosNomina/terSarFovTotalNom.do" progressIcon="false" />
                    </td></tr>
                </table>
            </c:if>
        </td></tr>
