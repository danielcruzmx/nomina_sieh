...
<html:form modelAttribute="reportesTercerosDTO">
    ...
    <spring:message code="sireh.label.terceros.reportes.seguroPagoTrimestralAnticioadol.detalle.titulo.link"/>
            </strong>
    </h1>
            ...
            <tr>
                <td align="right">
                    <fsn:submit value="submit.accept" 
                                path="muestraReporte"
                                action="reporteTercerosNomina/pagoTrimestralAnticipado.do"/>
                </td>
                <td align="left">
                ...
                <tr>
                    <td align="left">
                        ...
                        <fsn:report provider="jasper" 
                                    viewUri="/terceros/pagoTrimestral_Anticipado" 
                                    imagesUri="/images/reports" 
                                    format="pdf" 
                                    fileName="pagoTrimestralAnticipado" 
