...
<html:form modelAttribute="solicitudCompromisoDTO">
    
    <h1><spring:message code="sireh.label.clc.titulo.link"/> - 
    <spring:message code="sireh.label.clc.interfaz.titulo.link"/> - 
    <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.titulo"/></h1>
    <p>&nbsp;</p>
            ...
            <tr valign="top">
                <td>
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.beneficiario"/></td>
                                <td width="450px" align="left">
                                    <fsn:helpRoutine path="idBeneSicop"  
                                                     maxlength="20" 
                                                     size="20" 
                                                     disabled="true" 
                                                     beanName="solCompBeneficiariosPopUp"  
                                                     width="800" 
                                                     height="400"  
                            ...
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.bsCtaBancaria"/></td>
                                <td width="450px" align="left">
                                    <fsn:input path="bsCtaBancaria" readonly="true" size="20" uppercase="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.bsTipoMoneda"/></td>
                                <td width="450px" align="left">
                                    <fsn:input path="bsTipoMoneda" readonly="true" size="20" uppercase="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.bsLeyenda"/></td>
                                <td width="450px" align="left">
                                    <fsn:input path="bsLeyenda" readonly="true" size="20" uppercase="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.bsTipoPago"/></td>
                                <td width="450px" align="left">
                                    <fsn:input path="bsTipoPago" readonly="true" size="20" uppercase="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.bsPlurianual"/></td>
                                <td width="450px" align="left">
                                    <html:select path="temporalidad">
                                        <html:option value="N" label="NO"/>
                                        <html:option value="S" label="SI"/>
                                    </html:select>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.bsAutPlurianual"/></td>
                                <td width="450px" align="left">
                                    <fsn:input path="aprobPla" readonly="false" size="30" uppercase="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"> * <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cabecera.concepto"/></td>
                                <td width="450px" align="left">
    ...
    <c:set var="content2">
        <table align="center" width="60%">
            <tr valign="top">
                <td>
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlcCiclo"/></td>
                                <td width="450px" align="left">
                            ...
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlcQnaPago"/></td>
                                <td width="450px" align="left">
                                    <fsn:option key="" value="selectList.nonValue"/>
                            ...
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.idTipoNomina"/></td>
                                <td width="450px" align="left">
			...
			<table width="100%">
                            <tr align="center">
                                <td>
                                    <fsn:submit value="submit.search" 
                                                path="buscaCxlc" 
                                                action="clcInterfazSICOP/buscaCxlc.do"
                                                progressBar="true"/> &nbsp; 
                            ...
                            <c:choose>
                                <c:when test="${solicitudCompromisoDTO.buscaCxlc}">                                    
                                    <fsn:filter property="CXLC_CICLO" condition="=" path="cxlcCiclo"/>
                                    <fsn:filter property="CXLC_QNA_PAGO" condition="IN" path="quincenasList"/>
                                    ...
                                    <fsn:pagedList beanName="busquedaClcSolicitudCompromiso" 
                                                   checkbox="true" 
                                                   chkProperty="cxlcGrupo" 
                                                   baseUrl="solicitudCompromiso">
                                        
                                        <div id="displayTagDiv" style="width:800px;height:300px;overflow:auto;">
                                            <display:table name="busquedaClcSolicitudCompromiso" 
                                                           class="displaytag" 
                                                           pagesize="500" 
                                                           ...
                                                           sort="list">
                                                <%--display:column titleKey="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlcGrupo" 
                                                ...
                                                <display:column titleKey="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlc" 
                                                                property="cxlc" 
                                                                sortable="true"/>
                                                <display:column titleKey="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlcCiclo" 
                                                                property="cxlcCiclo" 
                                                                sortable="true"/>
                                                <display:column titleKey="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlcQnaPago" 
                                                                property="cxlcQnaPago" 
                                                                sortable="true"/>
                                                <display:column titleKey="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.idTipoNomina" 
                                                                property="idTipoNomina" 
                                                                sortable="true"/>
                                                <display:column titleKey="sireh.label.clc.interfaz.solicitudCompromiso.cuentas.cxlcComplemento" 
            ...
            <tr valign="top">
                <td>
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.fechaExp"/></td>
                                <td width="450px" align="left">
                                    <fsn:calendar path="fechaExp" size="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.fechaApli"/></td>
                                <td width="450px" align="left">
                                    <fsn:calendar path="fechaApli" size="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.fechaIni"/></td>
                                <td width="450px" align="left">
                                    <fsn:calendar path="fechaIni" size="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.fechaFin"/></td>
                                <td width="450px" align="left">
                                    <fsn:calendar path="fechaFin" size="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.fechaComp"/></td>
                                <td width="450px" align="left">
                                    <fsn:calendar path="fechaComp" size="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"> * <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.doctoRef"/></td>
                                <td width="450px" align="left">
                                    <fsn:textarea path="doctoRef" rows="3" cols="70" css="anchoTextarea"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label">* <spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.mes"/></td>
                                <td width="450px" align="left">
                            ...
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.otros.qnaPago"/></td>
                                <td width="450px" align="left">
            ...
            <tr valign="top">
                <td>
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.consejerias.tipoCambio"/></td>
                                <td width="450px" align="left">
                                    <fsn:input path="tipoCambio" size="20"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.consejerias.referencia"/></td>
                                <td width="450px" align="left">
                                    <fsn:textarea path="referencia" rows="3" cols="70" css="anchoTextarea"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px" align="right" class="label"><spring:message code="sireh.label.clc.interfaz.solicitudCompromiso.consejerias.fechaRef"/></td>
                                <td width="450px" align="left">
        ...
        <tr>
            <td align="center">
                <fsn:submit value="submit.generate.manual" 
                            action="clcInterfazSICOP/genSolCompManual.do"
                            alertCode="confirm.clc.interfaz.solicitudCompromiso"
                            progressBar="true"/> &nbsp; 
                
                <fsn:submit value="submit.cancel" 
                            action="clcInterfazSICOP/solicitudCompromiso.do"
                            progressBar="true"/> &nbsp; 
                            
                <c:if test="${solicitudCompromisoDTO.csvFileName ne null and solicitudCompromisoDTO.csvFileName ne ''}">
                    <script type="text/javascript">
                        $j("#10003").prop("disabled",true);
                    </script>
                    <fsn:submit value="submit.download" 
                                action="clcInterfazSICOP/downloadZipFile.do" 
                                progressIcon="false"/>
                </c:if>
            </td>
        </tr>
    ...
    <script type="text/javascript">
        ...
        function deleteOptions() {
            ...
            var nominaSeleccionada = '<c:out value="${solicitudCompromisoDTO.idTipoNomina}" />';
    ...
    <c:if test="${solicitudCompromisoDTO.buscaCxlc}">
        <script type="text/javascript">
            $j(function(){
