...
<html:form modelAttribute="consultaCalendarioDTO">
    ...
    <h1><spring:message code="sireh.label.spc.capcer.reportes.general.consultaLayoutRHNet.title"/></h1>
    <p>&nbsp;</p>
                        ...
                        <td valign="top" align="left" style="vertical-align: top">
                            <fieldset>
                                ...
                                <table width="100%">
                                    <tbody>
                                        <tr align="left">
                                            <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.consultaLayoutRHNet.ciclo"/>:</td>
                                            <td colspan="3">
                                        ...
                                        <tr align="left">
                                            <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.consultaLayoutRHNet.trimestre"/>:</td>
                                            <td colspan="3">
                    ...
                    <tr align="center">
                        <td align="center">
                            <fsn:submit value="submit.accept" 
                                        path="muestraReporte"
                                        action="consultaCursoSPC/createRhnet.do" progressIcon="false"/>
                             &nbsp; 
                            <fsn:submit value="submit.cancel" 
                                        path="cancel" 
                                        action="consultaCursoSPC/consultaLayoutRHNet.do"/>
                        </td>
                    </tr>
                </table>
                <!--FORMULARIO BUSQUEDA-->
