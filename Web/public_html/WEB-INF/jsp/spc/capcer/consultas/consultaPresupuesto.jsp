...
<html:form modelAttribute="consultaPresupuestoDTO">
    ...
    <h1><spring:message code="sireh.label.spc.capcer.reportes.general.consultaPresupuesto.title"/></h1>
    <p>&nbsp;</p>
                        ...
                        <td valign="top" align="left" style="vertical-align: top">
                            <fieldset>
                                ...
                                <table width="100%">
                                    <tbody>
                                        <tr align="left">
                                            <td class="label">* <spring:message code="sireh.label.spc.capcer.reportes.general.consultaPresupuesto.ciclo"/>:</td>
                                            <td colspan="3">
                                        ...
                                        <tr align="left">
                                            <td class="label"><spring:message code="sireh.label.spc.capcer.reportes.general.consultaPresupuesto.trimestre"/>:</td>
                                            <td colspan="3">
                   ...
                   <tr align="center">
                        <td align="center">
                            <fsn:submit value="submit.accept" 
                                        path="muestraReporte"
                                        action="consultaCursoSPC/createFilePresupuesto.do" progressIcon="false"/>
                             &nbsp; 
                            <fsn:submit value="submit.cancel" 
                                        path="cancel" 
                                        action="consultaCursoSPC/consultaPresupuesto.do"/>
                        </td>
                      </tr>
                </table>
                <!--FORMULARIO BUSQUEDA-->
