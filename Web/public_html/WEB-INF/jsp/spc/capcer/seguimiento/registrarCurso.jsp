                ...
                <fieldset>
                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.registro.registrarCurso.noParticipantes"/>:</td>
                                <td><c:out value="${registrarCursoDTO.noParticipantes}" /></td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset><br/><br/>
                ...
                <fieldset id="fieldsetCertificacion">
                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.registro.registrarCurso.tipoCapacidad"/>:</td>
                                <td>
                                    <fsn:option key="" value="selectList.nonValue"/>
                                    <fsn:selectList beanName="tcCapTipoCapacidad-registrarCurso" 
                                                    path="tipoCapacidad"
                                                    style="width:200px;"/>
                                </td>
                            </tr>
                            ...
                            <tr align="left">
                                <td class="label"><spring:message code="sireh.label.spc.capcer.registro.registrarCurso.supervisorSHCP"/>:</td>
                                <td>
                                    <fsn:input path="supervisorSHCP"
                                               uppercase="true" 
                                               maxlength="20"
                                               size="60"
                        ...
                        <td align="center">
                            <c:if test="${registrarCursoDTO.rolAdministradorCapacitacion || registrarCursoDTO.rolOperadorCapacitacion}">
                                <fsn:submit value="submit.save" 
                                            ...
                                            action="seguimientoCursoSPC/${registrarCursoDTO.viewName}.do"
                                            progressBar="true"
                                            alertCode="confirm.spc.capcer.registro.registrarCurso"/> &nbsp;
                            </c:if>
                            <fsn:submit value="submit.cancel" 
                                        action="seguimientoCursoSPC/consultaCurso.do"
                                        progressBar="true"/>
                        </td>
                    </tr>
                </table>
