...
public class _cancelacionPlazaEstructuraMasivosResultado extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _cancelacionPlazaEstructuraMasivosResultado page = this;
          ...
          if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
          {
            do {
              ...
              out.write(__oracle_jsp_text[5]);
              {
                ...
                __jsp_taghandler_3.setCode("sireh.label.plaza.masivas.cancelacion.mensaje.update");
                try {
