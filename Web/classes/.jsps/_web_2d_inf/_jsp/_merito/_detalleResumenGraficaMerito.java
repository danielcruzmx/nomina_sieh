...
public class _detalleResumenGraficaMerito extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _detalleResumenGraficaMerito page = this;
        ...
        try {
          ...
          if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
          {
            do {
              ...
              {
                _oracle._jsp._tag._graficaMerito_tag __jsp_taghandler_3=(_oracle._jsp._tag._graficaMerito_tag)OracleJspRuntime.getSimpleTagHandler(_oracle._jsp._tag._graficaMerito_tag.class, pageContext);
                __jsp_taghandler_3.setParent(__jsp_taghandler_2);
                __jsp_taghandler_3.setJspContext(pageContext);
                __jsp_taghandler_3.setRfc((java.lang.String)oracle.jsp.runtime.OracleJspRuntime.evaluate("${resumenMeritoDTO.tdNmrRfc}",java.lang.String.class, __ojsp_varRes,null));
