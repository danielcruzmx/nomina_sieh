...
public class _option_tag extends javax.servlet.jsp.tagext.SimpleTagSupport  implements oracle.jsp.runtime.OracleTagFile
{
  ...
  public void doTag() throws javax.servlet.jsp.JspException, java.io.IOException { 
    ...
    public TagInfo getTagInfo(TagLibraryInfo tlib)
    {
      ...
      TagAttributeInfo[] tagAttributeInfo = {
        new TagAttributeInfo("key",true,"java.lang.String",true,false),
        new TagAttributeInfo("value",true,"java.lang.String",true,false)};

      tagInfo = new TagInfo("option","_oracle._jsp._tag._option_tag","SCRIPTLESS","null",tlib,null,tagAttributeInfo,"null","null","null",tagVariableInfos,false);
      return tagInfo;
    }
