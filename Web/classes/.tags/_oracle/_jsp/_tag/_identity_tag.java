...
import gob.shcp.fsn.service.identity.IdentityService;
import gob.shcp.fsn.service.identity.User;


public class _identity_tag extends javax.servlet.jsp.tagext.SimpleTagSupport  implements oracle.jsp.runtime.OracleTagFile
{
  ...
  public void doTag() throws javax.servlet.jsp.JspException, java.io.IOException { 
    ...
    public TagInfo getTagInfo(TagLibraryInfo tlib)
    {
      ...
      TagAttributeInfo[] tagAttributeInfo = {
        new TagAttributeInfo("userName",true,"java.lang.String",true,false),
        new TagAttributeInfo("var",true,"java.lang.String",true,false),
        new TagAttributeInfo("scope",false,"java.lang.String",true,false)};

      tagInfo = new TagInfo("identity","_oracle._jsp._tag._identity_tag","SCRIPTLESS","null",tlib,null,tagAttributeInfo,"null","null","null",tagVariableInfos,false);
      return tagInfo;
    }
